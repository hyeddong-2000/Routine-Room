...
import { MdDashboard, MdViewKanban, MdMeetingRoom, MdChat, MdLogout } from 'react-icons/md'
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 h-16 bg-white border-t flex items-center safe-area-pb">
      ...
      <button
        ...
        className="flex-1 flex flex-col items-center justify-center gap-0.5 text-gray-400 active:text-red-400 transition-colors h-full"
      >
        <MdLogout size={22} />
